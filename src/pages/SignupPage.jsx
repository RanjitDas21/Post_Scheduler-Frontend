...
import { Mail, Lock, User, Repeat } from "lucide-react";
    ...
    <div className="min-h-screen bg-cream flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-xl2 shadow-warm p-8">
        <div className="flex flex-col items-center mb-7">
          ...
          <p className="text-sm text-ink-muted mt-1">Free while you're getting started</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-sm font-medium text-ink-light block mb-1.5">Name</label>
        ...
        <p className="text-center text-sm text-ink-muted mt-6">
          ...
          <Link to="/login" className="text-rust-600 font-medium">
            Sign in
          </Link>
        </p>
      </div>
